...
class AiScheduleService extends ChangeNotifier {
  ...
  Future<void> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
      ...
      Lists any scheduling conflicts or state that there are none.
      2, ### Ranked tasks
      ...
      4. ### Explanation
      Explain wht this recommendation was made in simple language that a student would easily understand.
      
      Ensure the markdown is well-formatted and easy to read. Do not include extra text of these headers. 
      ''';
